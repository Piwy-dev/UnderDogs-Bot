...
module.exports = (client) => {
    client.on('guildMemberAdd', async(member) => {
        ...
        const result = keys.welcomeChannels.find(c => c.guild === guild.id)
        if (!result) return console.log("Le serveur n'a pas de salon de bienvenue.")

        const welcomeChannel = guild.channels.cache.get(result.channel)
